...
export const sendEmailwithNodemailer = async (userId: string) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: ` <h3>Hey ${exists.name} 👋, Thank you for signing up! To complete the authentication process and access your account, please verify your email address by clicking the link below - </h3>
